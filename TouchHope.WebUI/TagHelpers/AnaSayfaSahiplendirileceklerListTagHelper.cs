...
namespace TouchHope.WebUI.TagHelpers
{
    ...
    [HtmlTargetElement("AnaSayfaSahiplendirResim")]
    public class AnaSayfaSahiplendirileceklerListTagHelper : TagHelper
    {
        private IResimApiService _resimApiService;
        public AnaSayfaSahiplendirileceklerListTagHelper(IResimApiService resimApiService)
        {
