...
namespace TouchHope.WebUI.TagHelpers
{
    ...
    [HtmlTargetElement("getirKaybolanResim")]
    public class ResimKaybolanHayvanTagHelper : TagHelper
    {
        private IResimApiService _resimApiService;
        public ResimKaybolanHayvanTagHelper(IResimApiService resimApiService)
        {
